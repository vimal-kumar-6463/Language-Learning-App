...
function InstLoginPage(props) {
    ...
    function handleSubmit(email , password ) {
      ...
      if(isValidEmail && isValidPassword) {
          ...
          (async() => {
            await axios.get("https://lingoapp-49792-default-rtdb.firebaseio.com/adminUser/"+email.replaceAll(".","-")+"/.json")
            .then(res => {
                ...
                setLinkedinId(res.data.linkedInId)
                console.log("Admin Data from firebase : ", res.data);
            })
    ...
    return (
      ...
      {!isAuthenticating ? <KeyboardAvoidingView style={styles.container}>
          <View style={styles.topPoster}>
              ...
              <Text style={styles.topText}>{"Welcome back Instructor"}</Text>
          </View>
          <ScrollView style={styles.scrollView}>
            <View style={styles.midBox}>
                ...
                <Pressable android_ripple={{color:"#2c3a4d"}} style={styles.button} onPress={() => handleSubmit(email , password)}>
          ...
          <View style={styles.bottomBox}>
              ...
              <Pressable style={styles.hyperLink} onPress={() => props.navigation.dispatch(StackActions.replace("InstructorSignInPage"))}>
                  <Text style={styles.hyperText}>{"Apply as a tutor"}</Text>
              </Pressable>
          </View>
